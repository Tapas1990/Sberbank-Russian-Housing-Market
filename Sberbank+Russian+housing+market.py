...
#load files
train = pd.read_csv('train_Russian.csv', parse_dates=['timestamp'])
test = pd.read_csv('test_Russian.csv', parse_dates=['timestamp'])
...
test = pd.read_csv('test_Russian.csv')
id_test = test.id
...
df_train = pd.read_csv("train_Russian.csv", parse_dates=['timestamp'])
df_test = pd.read_csv("test_Russian.csv", parse_dates=['timestamp'])
